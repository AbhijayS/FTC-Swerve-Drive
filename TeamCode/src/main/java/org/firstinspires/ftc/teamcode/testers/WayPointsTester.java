...
public class WayPointsTester extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        WayPoint[] wayPoints = new WayPoint[] {
                new WayPoint(new Pose(0,0,90),1, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.STOW_ALL,0,false,0,0, HardStops.HardStopState.STOW,0.01),
                new WayPoint(new Pose(-20,0,90),1, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.STOW_ALL,0,false,0,0, HardStops.HardStopState.STOW,0.01),
                new WayPoint(new Pose(-40,0,90),1, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.STOW_ALL,0,false,0,0, HardStops.HardStopState.STOW,0.01)
        };
