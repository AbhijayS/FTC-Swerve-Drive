...
//                        new WayPoint(new Pose(50,-33,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0, HardStops.HardStopState.STOW, 2),
            ...
            default: {
                wayPoints = new WayPoint[] {
                        ...
                        new WayPoint(new Pose(0,-15,90),0.5, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.DOCK_RIGHT,0, false,0,0, HardStops.HardStopState.DEPLOY, 2),
                        new WayPoint(new Pose(0,-22,90),0.2, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.POSSESS_RIGHT,200, false,0,0, HardStops.HardStopState.DEPLOY, 1),
                        // start heading to foundation
                        new WayPoint(new Pose(2,-22,90),0.5, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.STOW_ALL,0, false,0,0, HardStops.HardStopState.DEPLOY, 1),
                        new WayPoint(new Pose(10,-23,90),0.75, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.STOW_ALL,0, false,0,0, HardStops.HardStopState.DEPLOY, 1),
                        new WayPoint(new Pose(20,-23,90),1, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.STOW_ALL,0, false,0,0, HardStops.HardStopState.DEPLOY, 1),
                        new WayPoint(new Pose(40,-23,90),1, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.RIDE_HIGH_RIGHT,0, false,0,0, HardStops.HardStopState.DEPLOY, 1),
                        new WayPoint(new Pose(45,-23,90),0.5, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.RIDE_HIGH_RIGHT,0, false,0,0, HardStops.HardStopState.DEPLOY, 1),
                        ...
                        // head back to quarry
                        new WayPoint(new Pose(55,-25.8,90),0.9, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.STOW_ALL,0, false,0,0, HardStops.HardStopState.DEPLOY, 4),
                        ...
                        new WayPoint(new Pose(60,-23,90),0, Clamp.ClampState.PARTIAL, JewelSwatter.JewelSwatterState.RIDE_LOW_LEFT_OPEN,0, false,0,0, HardStops.HardStopState.DEPLOY, 4),
