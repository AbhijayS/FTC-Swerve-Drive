        ...
        switch (stonePosition) {
            case "A": {
                wayPoints = new WayPoint[]{
                        ...
                        new WayPoint(new Pose(66,-20,180),0.4, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_LEFT,0, false,0,0),
                        // return for second stone
                        new WayPoint(new Pose(50,-28,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_LEFT,0, false,0,0),
                        new WayPoint(new Pose(11,-28,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_LEFT,0, false,0,0),
                        new WayPoint(new Pose(0,-23,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_HIGH_LEFT,0, false,0,0),
            ...
            default: {
                wayPoints = new WayPoint[]{
                        ...
                        new WayPoint(new Pose(50,-27,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0),
                        new WayPoint(new Pose(52,-27,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_ALL,0, false,0,0),
                        // latch on
                        new WayPoint(new Pose(68,-33,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_ALL,0, true,0,0),
                        new WayPoint(new Pose(68,-34,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_ALL,0, false,0,0),
                        ...
                        new WayPoint(new Pose(67,-25,90),0.4, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_ALL,0, false,0,-ROBOT_LENGTH/2),
                        new WayPoint(new Pose(66,-18,180),0.3, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_ALL,5000, false,0,-ROBOT_LENGTH/2),
                        new WayPoint(new Pose(66,-20,180),0.4, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0),
                        // return for second stone
                        new WayPoint(new Pose(50,-28,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0),
                        new WayPoint(new Pose(11,-28,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0),
                        new WayPoint(new Pose(0,-23,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_HIGH_RIGHT,0, false,0,0),
                        new WayPoint(new Pose(-22,-28,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_RIGHT,500, true,0,0),
                        new WayPoint(new Pose(-22,-35,90),0.1, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.POSSESS_RIGHT,500, true,0,0),
                        new WayPoint(new Pose(-22,-35.5,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_HIGH_RIGHT,0, false,0,0),
                        new WayPoint(new Pose(-10,-35.5,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_HIGH_RIGHT,0, false,0,0),
                        new WayPoint(new Pose(0,-35.5,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0),
                };
                break;
            }
        }
