        ...
        switch (stonePosition) {
            case "A": {
                wayPoints = new WayPoint[]{
                        ...
                        new WayPoint(new Pose(0,0,90),0.75, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_LEFT,500, true,0,0, HardStops.HardStopState.PARTIAL_DEPLOY),
                        ...
                        new WayPoint(new Pose(50,-27,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_LEFT,0, false,0,0, HardStops.HardStopState.PARTIAL_DEPLOY),
                        ...
                        new WayPoint(new Pose(66,-20,180),0.4, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_LEFT,0, false,0,0, HardStops.HardStopState.PARTIAL_DEPLOY),
                        ...
                        new WayPoint(new Pose(-10,-33,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_HIGH_LEFT,0, false,0,0, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(0,-30,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_LEFT,0, false,0,0, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(75,-30,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_LEFT,0, false,0,0, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(50,-30,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_LEFT,0, false,0,0, HardStops.HardStopState.STOW),
                };
                break;
            }
            ...
            default: {
                wayPoints = new WayPoint[]{
                        ...
                        new WayPoint(new Pose(67,-25,90),0.4, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_ALL,0, false,0,-ROBOT_LENGTH/2, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(66,-18,180),0.3, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.DOCK_ALL,5000, false,0,-ROBOT_LENGTH/2, HardStops.HardStopState.PARTIAL_DEPLOY),
                        new WayPoint(new Pose(66,-20,180),0.4, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0, HardStops.HardStopState.PARTIAL_DEPLOY),
                        // return for second stone
                        new WayPoint(new Pose(50,-28,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(11,-28,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(0,-23,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_HIGH_RIGHT,0, false,0,0, HardStops.HardStopState.STOW),
                        ...
                        new WayPoint(new Pose(-22,-35,90),0.1, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.POSSESS_RIGHT,500, true,0,0, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(-22,-35.5,90),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_HIGH_RIGHT,0, false,0,0, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(-10,-35.5,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_HIGH_RIGHT,0, false,0,0, HardStops.HardStopState.STOW),
                        new WayPoint(new Pose(0,-35.5,180),0.5, Clamp.ClampState.CLAMP, JewelSwatter.JewelSwatterState.RIDE_LOW_RIGHT,0, false,0,0, HardStops.HardStopState.STOW),
                };
                break;
            }
        }
